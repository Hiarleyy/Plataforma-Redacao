...
router.patch("/usuarios/:id/resetar-senha", authMiddleware, adminMiddleware, usuariosController.resetPassword) 
...
router.post("/correcoes/:usuarioId/upload", authMiddleware, adminMiddleware, uploadCorrecoes.single("file"), correcoesController.create)
